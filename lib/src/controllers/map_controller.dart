...
class MapController extends ControllerMVC {
  ...
  Future getCurrentLocation() async {
    try {
      if (sett.myAddress.value.isUnknown()) {
  ...
  void getOrdersOfArea() async {
    setState(() {
      orders = <Order>[];
      Address areaAddress =
          Address.fromJSON({"latitude": cameraPosition.target.latitude, "longitude": cameraPosition.target.longitude});
  ...
  Future getDirectionSteps() async {
    currentAddress = sett.myAddress.value;
    mapsUtil
        .get("origin=" +
