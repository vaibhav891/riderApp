...
Future<User> login(User user) async {
  ...
  if (response.statusCode == 200) {
    ...
    var deviceToken = currentUser.value.deviceToken;
    ...
    response = await client.post(
      'http://online.ajmanmarkets.ae/api/pickerdevicetoken.php',
      headers: {HttpHeaders.contentTypeHeader: 'application/json'},
      body: json.encode({
...
//   final String url =
//       '${GlobalConfiguration().getString('api_base_url')}delivery_addresses?$_apiToken&search=user_id:${_user.id}&searchFields=entity_id:=&orderBy=entity_id&sortedBy=desc';
//   try {
//     final client = new http.Client();
